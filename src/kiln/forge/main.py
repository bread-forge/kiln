...
if TYPE_CHECKING:
    from kiln.config import Registry
...
async def spec_forge(
    ...
    *,
    ...
    from kiln.forge.drafter import _draft_spec
    from kiln.forge.interview import _apply_interview, _run_interview
    from kiln.forge.validator import _check_violations, validate_spec
