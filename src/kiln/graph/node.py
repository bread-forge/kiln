...
class BackendRouter:
    ...
    def from_env(cls) -> BackendRouter:
        """Construct from KILN_* environment variables."""
        import os

        return cls(
            build_model=os.environ.get("KILN_BUILD_MODEL", "claude-sonnet-4-6"),
            research_model=os.environ.get("KILN_RESEARCH_MODEL") or None,
            design_model=os.environ.get("KILN_DESIGN_MODEL") or None,
        )
